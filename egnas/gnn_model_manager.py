...
from egnas.gnn import GraphNet
from egnas.utils.model_utils import EarlyStop, TopAverage, process_action

import egnas.arch_process as g
...
class CitationGNNManager(object):
    ...
    def train(self, actions=None, format="two"):
        ...
        # val_acc = self.is_repreat_train(actions)
        # if val_acc >= self.max_val_acc:
        #     print(20*'-', 'train {0} again!'.format(actions), 20*'-')
        #     val_acc_list.append(val_acc)
        #     val_acc = self.is_repreat_train(actions)
        #     val_acc_list.append(val_acc)
        #     val_acc = float(np.mean(val_acc_list))
        #     self.max_val_acc = val_acc
        #     print('The average of two val_acc:', val_acc, 'val_acc_list:', val_acc_list, 'max_val_acc:', self.max_val_acc)
