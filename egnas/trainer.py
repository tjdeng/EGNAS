...
import egnas.utils.tensor_utils as utils
from egnas.gnn_model_manager import CitationGNNManager
from graphnas_variants.macro_graphnas.pyg.pyg_gnn_model_manager import GeoCitationManager

from egnas.ppo2 import PPOBuffer
from egnas.mlp import MLP
...
class Trainer(object):
    ...
    def build_model(self):
        ...
        if self.args.search_mode == "macro":
            ...
            from egnas.graphnas_controller import SimpleNASController
    ...
    def train(self):
        ...
        for self.epoch in range(self.start_epoch, self.args.max_epoch):
            # 1. Training the shared parameters of the child egnas
    ...
    def derive_from_history(self, path, top=10):
        ...
        if self.args.is_predictor:
            top_p = int(top/2)
            path_mlp = path + "_predictor" + '.txt'

            with open(path_mlp, "r") as f:
    ...
    def derive(self, sample_num=None, path=None, top=None):
        """
